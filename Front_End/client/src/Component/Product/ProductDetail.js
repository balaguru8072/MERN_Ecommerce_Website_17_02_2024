...
import { getProduct } from "../../actions/prdoctsActions";
...
export default function ProductDetail() {
    ...
    }, [dispatch, id]);  // Empty dependency array to ensure the effect runs only once
    ...
    // If product is null or undefined, display a message
    if (!product) {
                ...
                <Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                            ...
                            <Carousel pause="hover">
                                {product?.images && product?.images.map(image =>
                                    <Carousel.Item key={image._id}> 
                                        <img className="d-black w-100" src={image.image} alt={product?.name} height="500" width="500" />
                                    </Carousel.Item>
                                    )}
                            </Carousel>
                        </div>
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            <h3>{product?.name}</h3> {/* Optional chaining to avoid errors */}
                            <p id="product_id">Product # {product?._id}</p> {/* Optional chaining to avoid errors */}
